...
describe("computeStreak", () => {
  ...
  it("counts consecutive days ending today", () => {
    expect(
      computeStreak(["2026-07-06", "2026-07-05", "2026-07-04"], TODAY),
    ).toBe(3);
  });
  ...
  it("breaks on a gap", () => {
    expect(
      computeStreak(["2026-07-06", "2026-07-04", "2026-07-03"], TODAY),
    ).toBe(1);
  });

  it("dedupes multiple reviews on the same day", () => {
    expect(
      computeStreak(["2026-07-06", "2026-07-06", "2026-07-05"], TODAY),
    ).toBe(2);
  });
});
