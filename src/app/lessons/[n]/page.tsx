  ...
  return (
    <div className="space-y-8">
      ...
      <header className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand to-brand-soft p-6 text-white dark:from-rose-900 dark:to-slate-900">
        ...
        <div className="relative space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="font-jp text-sm text-white/80">{meta.titleJp}</span>
          </div>
      ...
      <section className="space-y-3">
        <SectionHeading emoji="📝" title={t("Grammar")} count={grammar.length} />
        {grammar.length === 0 ? (
      ...
      {/* Vocabulary */}
      <section className="space-y-3">
        <SectionHeading emoji="🗂️" title={t("Vocabulary")} count={vocab.length} />
