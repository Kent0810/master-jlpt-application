...
const scenes = [
  // 1 Introductions
  (a, a2) =>
    person(120, 245, 1.5, a) +
    person(280, 245, 1.5, a2) +
  ...
  // 2 This and That
  (a, a2) =>
    rrect(150, 130, 100, 90, 12, a) +
    bubble(210, 55, 90, 60) +
    qmark(255, 92, 1.1, INK) +
    arrow(90, 175, 145, 175, a2, 7),
  // 3 Places
  (a, a2) =>
    rrect(60, 120, 130, 110, 10, "#fff", a, 6) +
    pathf(`M 55 120 L 125 80 L 195 120 Z`, a) +
    pin(300, 90, 1.3, a2) +
    arrow(210, 175, 265, 150, INK, 6),
  // 4 Time & Daily Verbs
  (a) => clock(200, 150, 78, a),
  // 5 Going Places
  (a, a2) =>
    rrect(70, 150, 200, 70, 18, a) +
    rrect(90, 165, 50, 34, 6, "#fff") +
    rrect(160, 165, 50, 34, 6, "#fff") +
    circle(110, 228, 14, INK) +
    circle(230, 228, 14, INK) +
    line(50, 250, 350, 250, LIGHT, 6) +
    pathf(`M 300 120 L 300 150 L 340 135 Z`, a2),
  // 6 Doing Things
  (a, a2) =>
    line(90, 210, 310, 210, INK, 7) +
    line(120, 210, 120, 255, INK, 7) +
    line(280, 210, 280, 255, INK, 7) +
    circle(170, 190, 26, "#fff", a, 6) +
    circle(170, 190, 10, a) +
    rrect(230, 165, 34, 40, 6, a2) +
    line(264, 178, 280, 178, a2, 6),
  // 7 Tools & Giving
  (a, a2) => giftBox(150, 150, 100, 90, a) + heart(320, 90, 1.2, a2),
  // 8 Adjectives
  (a, a2) =>
    mountain(60, 235, 150, 150, a) +
    flower(300, 200, 2.2, a2) +
    line(300, 214, 300, 250, "#65A30D", 6),
  // 9 Likes & Reasons
  ...
  (a, a2) =>
    ...
    rrect(84, 132, 15, 34, 3, a) +
    rrect(104, 130, 15, 36, 3, a2) +
    rrect(124, 134, 15, 32, 3, AC[5]) +
    rrect(150, 138, 15, 28, 3, a) +
    // cat
    pathf(`M 258 168 L 265 150 L 276 168 Z`, a) +
    pathf(`M 292 168 L 299 150 L 306 168 Z`, a) +
    circle(282, 182, 20, a) +
  ...
  // 12 Past & Comparison
  (a, a2) =>
    line(200, 70, 200, 150, INK, 6) +
    line(120, 110, 280, 90, INK, 6) +
    circle(120, 150, 34, a) +
    circle(280, 130, 20, a2) +
    line(120, 130, 120, 150, INK, 5) +
    line(280, 118, 280, 130, INK, 5) +
    rrect(185, 150, 30, 40, 4, INK),
  // 13 Wants & Purpose
  (a, a2) =>
    rrect(90, 90, 150, 130, 10, "#fff", INK, 6) +
    star(165, 155, 2.2, a) +
    bubble(250, 70, 90, 58) +
    star(295, 100, 1.2, a2),
  // 14 The te-form (request)
  (a, a2) =>
    person(150, 250, 1.5, a) +
    pathf(`M 150 250 q 60 0 70 -40`, "none", INK, 5) +
    bubble(240, 90, 100, 54) +
    line(258, 112, 322, 112, LIGHT, 6) +
    line(258, 124, 300, 124, LIGHT, 6),
  // 15 Permission
  (a, a2) =>
    checkBadge(140, 150, 52, "#22C55E") + noEntry(280, 150, 50, "#F43F5E"),
  // 16 Connecting Actions
  (a, a2) =>
    circle(90, 150, 24, a) +
    circle(200, 150, 24, a2) +
    circle(310, 150, 24, a) +
    arrow(118, 150, 172, 150, INK, 6) +
    arrow(228, 150, 282, 150, INK, 6),
  // 17 The nai-form
  (a, a2) =>
    person(150, 250, 1.4, a) +
    line(150, 175, 150, 130, a, 8) +
    circle(150, 118, 12, a) +
    crossBadge(280, 130, 42, "#F43F5E"),
  // 18 Dictionary Form
  (a, a2) =>
    pathf(
      `M 70 110 Q 200 80 200 120 Q 200 80 330 110 L 330 220 Q 200 190 200 230 Q 200 190 70 220 Z`,
      "#fff",
      INK,
      6,
    ) +
    line(200, 120, 200, 230, INK, 5) +
    star(300, 90, 1.4, a2),
  // 19 The ta-form
  (a, a2) =>
    bubble(90, 70, 150, 110) + pin(165, 95, 1.2, a) + person(300, 250, 1.2, a2),
  // 20 Plain / Casual
  (a, a2) => bubble(70, 80, 130, 70, a) + bubble(210, 130, 130, 70, a2),
  // 21 Opinions
  (a, a2) =>
    person(160, 250, 1.5, a) +
    (() => {
      // cloud bubble
      const c = "#fff";
      return (
        circle(280, 100, 34, c, INK, 5) +
        circle(320, 115, 22, c, INK, 5) +
        circle(250, 120, 22, c, INK, 5) +
        circle(215, 175, 7, c, INK, 4) +
        circle(232, 155, 11, c, INK, 4)
      );
    })() +
    line(280, 96, 280, 112, a2, 6) +
    circle(280, 122, 4, a2),
  // 22 Describing Nouns
  (a, a2) =>
    person(110, 250, 1.1, LIGHT) +
    person(290, 250, 1.1, LIGHT) +
    person(200, 250, 1.3, a) +
    circle(200, 150, 46, "none", a2, 7) +
    line(233, 183, 270, 220, a2, 8),
  // 23 When & If
  (a, a2) =>
    pathf(`M 70 250 L 200 250 L 200 120`, "none", LIGHT, 20) +
    pathf(`M 70 250 L 200 250 L 200 120`, "none", INK, 6) +
    arrow(200, 160, 200, 120, a, 6) +
    clock(315, 90, 30, a2),
  // 24 Giving & Receiving
  (a, a2) =>
    person(110, 245, 1.3, a) +
    person(290, 245, 1.3, a2) +
    heart(200, 140, 1.6, "#F43F5E") +
    arrow(150, 150, 185, 145, INK, 5) +
    arrow(250, 150, 215, 145, INK, 5),
  // 25 Conditionals
  (a, a2) =>
    line(160, 250, 160, 120, INK, 8) +
