...
module.exports = {
  examples: {
    l3_koko_soko_asoko: [
      {
        jp: "ここは教室です。",
        en: "This place is a classroom.",
        vi: "Đây là phòng học.",
      },
      {
        jp: "そこは食堂です。",
        en: "That place (by you) is the dining hall.",
        vi: "Chỗ đó là nhà ăn.",
      },
      {
        jp: "あそこはトイレです。",
        en: "That place over there is the toilet.",
        vi: "Kia là nhà vệ sinh.",
      },
    ],
    l3_wa_place: [
      {
        jp: "受付はあそこです。",
        en: "The reception is over there.",
        vi: "Quầy tiếp tân ở đằng kia.",
      },
      {
        jp: "ミラーさんは事務所です。",
        en: "Mr. Miller is in the office.",
        vi: "Anh Miller đang ở văn phòng.",
      },
      {
        jp: "トイレはそこです。",
        en: "The toilet is there.",
        vi: "Nhà vệ sinh ở đó.",
      },
    ],
  },
  ...
  exercises: {
    3: {
      ...
      items: [
        {
          prompt: "（　）は食堂です。（this place）",
          options: ["ここ", "これ", "この", "どこ"],
          answer: 0,
          explanation: {
            en: "ここ names a place ('this place').",
            vi: "ここ chỉ nơi chốn ('chỗ này').",
          },
        },
        {
          prompt: "受付は（　）です。（over there）",
          options: ["あそこ", "あれ", "あの", "どれ"],
          answer: 0,
          explanation: {
            en: "あそこ = 'over there' (far from both).",
            vi: "あそこ = 'đằng kia' (xa cả hai).",
          },
        },
        {
          prompt: "トイレ（　）どこですか。",
          ...
          answer: 0,
          explanation: {
            en: "は marks the topic before asking どこですか.",
            vi: "は đánh dấu chủ đề trước khi hỏi どこですか.",
          },
        },
        {
          prompt: "「事務所はどこですか。」「（　）です。」",
          options: ["あそこ", "あれ", "どれ", "この"],
          answer: 0,
          explanation: {
            en: "Answer a どこ question by naming the place.",
            vi: "Trả lời câu hỏi どこ bằng cách nêu nơi chốn.",
          },
        },
        {
          prompt: "ミラーさん（　）事務所です。",
          ...
          answer: 0,
          explanation: {
            en: "は…です states where Mr. Miller is.",
            vi: "は…です nói anh Miller ở đâu.",
          },
        },
      ],
    },
